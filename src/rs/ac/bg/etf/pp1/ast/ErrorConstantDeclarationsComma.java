...
public class ErrorConstantDeclarationsComma extends ConstDeclarations {

    private ConstDeclarations constDeclarations;
    private ConstDeclValue constDeclValue;

    public ErrorConstantDeclarationsComma (ConstDeclarations constDeclarations, ConstDeclValue constDeclValue) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ErrorConstantDeclarationsComma(\n");
